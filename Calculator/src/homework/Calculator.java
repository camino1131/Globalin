package homework;//Home work 패키지에 위치함

import java.awt.*;//API 를 가져옴
import java.awt.event.*;
import javax.swing.*;

// 지금 여기 까지 했는데 가져와서 사용하긴 했는데 전혀 모르겠습니다. 
// 계산기 작업이 많이 어려운 거 같아요 
// 지금 전혀 감이 않 잡혀요.
public class Calculator extends Frame implements ActionListener{//Calculator 클래스가 Frame을 상속받았다.  ActionListener라는 인터페이스를 Implements 했다. 
	...
	public Calculator() {
	   ...
	   setLayout(new BorderLayout());
		...
		jlbResult1 = new JLabel("1",JLabel.RIGHT);
