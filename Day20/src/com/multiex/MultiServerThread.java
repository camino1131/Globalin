...
public class MultiServerThread extends Thread{
	...
	public void broadcasting(String msg)throws IOException{
		 ...
		 * 각각의 MultiServerThread의 sendMsg메소들를 호출해서
		 * 연결된 클라이언트에게 메시지를 전달함
		 */
		
		for(MultiServerThread t : clientList) {
			//각각의 MultiServerThread의 sendMsg메소드를 호출하는 메시지를 
			//각각의 클라이언트에게 전달됨
	...
	//전달받은 메시지를 소켓을 OutputStream과 연결된 PrintWriter를 이용해서
	//클라이언트에게 전달하는 기능
